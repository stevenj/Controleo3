...
static const int jpeg_zigzag_order[8][8] = {{0, 1, 5, 6, 14, 15, 27, 28},
...
static const int jpeg_zigzag_order7[7][7] = {{0, 1, 5, 6, 14, 15, 27},
                                             {2, 4, 7, 13, 16, 26, 28},
                                             {3, 8, 12, 17, 25, 29, 38},
                                             {9, 11, 18, 24, 30, 37, 39},
...
static const int jpeg_zigzag_order6[6][6] = {{0, 1, 5, 6, 14, 15},
                                             {2, 4, 7, 13, 16, 25},
                                             {3, 8, 12, 17, 24, 26},
                                             {9, 11, 18, 23, 27, 32},
                                             {10, 19, 22, 28, 31, 33},
...
static const int jpeg_zigzag_order4[4][4] = {{0, 1, 5, 6}, {2, 4, 7, 12}, {3, 8, 11, 13}, {9, 10, 14, 15}};
...
start_pass_huff_decoder(j_decompress_ptr cinfo)
{
	...
	if (cinfo->progressive_mode) {
		...
		if (cinfo->Ss != 0 || cinfo->Ah != 0 || cinfo->Al != 0
		    || ((cinfo->is_baseline || cinfo->Se < DCTSIZE2) && cinfo->Se != cinfo->lim_Se))
