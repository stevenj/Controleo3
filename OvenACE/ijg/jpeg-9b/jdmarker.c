...
/* Process a SOS marker */
{
	...
	if (length != (n * 2 + 6) || n > MAX_COMPS_IN_SCAN || (n == 0 && !cinfo->progressive_mode))
	...
	id_found:
		...
		TRACEMS3(cinfo, 1, JTRC_SOS_COMPONENT, compptr->component_id, compptr->dc_tbl_no, compptr->ac_tbl_no);
	}
