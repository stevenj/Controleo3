       ...
       GLOBAL(void) jpeg_fdct_islow(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < DCTSIZE; ctr++) {
		...
		dataptr[2] = (DCTELEM)RIGHT_SHIFT(z1 + MULTIPLY(tmp12, FIX_0_765366865), /* c2-c6 */
		                                  CONST_BITS - PASS1_BITS);
		dataptr[6] = (DCTELEM)RIGHT_SHIFT(z1 - MULTIPLY(tmp13, FIX_1_847759065), /* c2+c6 */
		                                  CONST_BITS - PASS1_BITS);
	...
	for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
		...
		dataptr[DCTSIZE * 2] = (DCTELEM)RIGHT_SHIFT(z1 + MULTIPLY(tmp12, FIX_0_765366865), /* c2-c6 */
		                                            CONST_BITS + PASS1_BITS);
		dataptr[DCTSIZE * 6] = (DCTELEM)RIGHT_SHIFT(z1 - MULTIPLY(tmp13, FIX_1_847759065), /* c2+c6 */
		                                            CONST_BITS + PASS1_BITS);
...
jpeg_fdct_7x7(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 7; ctr++) {
		...
		z1 = tmp0 + tmp2;
		/* Apply unsigned->signed conversion. */
		dataptr[0] = (DCTELEM)((z1 + tmp1 + tmp3 - 7 * CENTERJSAMPLE) << PASS1_BITS);
		tmp3 += tmp3;
		z1 -= tmp3;
		z1 -= tmp3;
		...
		dataptr[4] = (DCTELEM)DESCALE(z2 + z3 - MULTIPLY(tmp1 - tmp3, FIX(0.707106781)), /* c2+c6-c4 */
		                              CONST_BITS - PASS1_BITS);
	...
	for (ctr = 0; ctr < 7; ctr++) {
		...
		z1                   = tmp0 + tmp2;
		dataptr[DCTSIZE * 0] = (DCTELEM)DESCALE(MULTIPLY(z1 + tmp1 + tmp3, FIX(1.306122449)), /* 64/49 */
		                                        CONST_BITS + PASS1_BITS);
		tmp3 += tmp3;
		z1 -= tmp3;
		z1 -= tmp3;
		...
		dataptr[DCTSIZE * 4] = (DCTELEM)DESCALE(z2 + z3 - MULTIPLY(tmp1 - tmp3, FIX(0.923568041)), /* c2+c6-c4 */
		                                        CONST_BITS + PASS1_BITS);
...
jpeg_fdct_6x6(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 6; ctr++) {
		...
		/* Apply unsigned->signed conversion. */
		dataptr[0] = (DCTELEM)((tmp10 + tmp11 - 6 * CENTERJSAMPLE) << PASS1_BITS);
		dataptr[2] = (DCTELEM)DESCALE(MULTIPLY(tmp12, FIX(1.224744871)), /* c2 */
		                              CONST_BITS - PASS1_BITS);
		dataptr[4] = (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp11 - tmp11, FIX(0.707106781)), /* c4 */
		                              CONST_BITS - PASS1_BITS);
	...
	for (ctr = 0; ctr < 6; ctr++) {
		...
		dataptr[DCTSIZE * 0] = (DCTELEM)DESCALE(MULTIPLY(tmp10 + tmp11, FIX(1.777777778)), /* 16/9 */
		                                        CONST_BITS + PASS1_BITS);
		dataptr[DCTSIZE * 2] = (DCTELEM)DESCALE(MULTIPLY(tmp12, FIX(2.177324216)), /* c2 */
		                                        CONST_BITS + PASS1_BITS);
		dataptr[DCTSIZE * 4] = (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp11 - tmp11, FIX(1.257078722)), /* c4 */
		                                        CONST_BITS + PASS1_BITS);
		...
		dataptr[DCTSIZE * 1] = (DCTELEM)DESCALE(tmp10 + MULTIPLY(tmp0 + tmp1, FIX(1.777777778)), /* 16/9 */
		                                        CONST_BITS + PASS1_BITS);
		dataptr[DCTSIZE * 3] = (DCTELEM)DESCALE(MULTIPLY(tmp0 - tmp1 - tmp2, FIX(1.777777778)), /* 16/9 */
		                                        CONST_BITS + PASS1_BITS);
		dataptr[DCTSIZE * 5] = (DCTELEM)DESCALE(tmp10 + MULTIPLY(tmp2 - tmp1, FIX(1.777777778)), /* 16/9 */
		                                        CONST_BITS + PASS1_BITS);
...
jpeg_fdct_5x5(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 5; ctr++) {
		...
		/* Apply unsigned->signed conversion. */
		dataptr[0] = (DCTELEM)((tmp10 + tmp2 - 5 * CENTERJSAMPLE) << (PASS1_BITS + 1));
		...
		dataptr[1] = (DCTELEM)DESCALE(tmp10 + MULTIPLY(tmp0, FIX(0.513743148)), /* c1-c3 */
		                              CONST_BITS - PASS1_BITS - 1);
		dataptr[3] = (DCTELEM)DESCALE(tmp10 - MULTIPLY(tmp1, FIX(2.176250899)), /* c1+c3 */
		                              CONST_BITS - PASS1_BITS - 1);
	...
	for (ctr = 0; ctr < 5; ctr++) {
		...
		dataptr[DCTSIZE * 0] = (DCTELEM)DESCALE(MULTIPLY(tmp10 + tmp2, FIX(1.28)), /* 32/25 */
		                                        CONST_BITS + PASS1_BITS);
		...
		dataptr[DCTSIZE * 1] = (DCTELEM)DESCALE(tmp10 + MULTIPLY(tmp0, FIX(0.657591230)), /* c1-c3 */
		                                        CONST_BITS + PASS1_BITS);
		dataptr[DCTSIZE * 3] = (DCTELEM)DESCALE(tmp10 - MULTIPLY(tmp1, FIX(2.785601151)), /* c1+c3 */
		                                        CONST_BITS + PASS1_BITS);
...
jpeg_fdct_4x4(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 4; ctr++) {
		...
		/* Apply unsigned->signed conversion. */
		dataptr[0] = (DCTELEM)((tmp0 + tmp1 - 4 * CENTERJSAMPLE) << (PASS1_BITS + 2));
		...
		dataptr[1] = (DCTELEM)RIGHT_SHIFT(tmp0 + MULTIPLY(tmp10, FIX_0_765366865), /* c2-c6 */
		                                  CONST_BITS - PASS1_BITS - 2);
		dataptr[3] = (DCTELEM)RIGHT_SHIFT(tmp0 - MULTIPLY(tmp11, FIX_1_847759065), /* c2+c6 */
		                                  CONST_BITS - PASS1_BITS - 2);
	...
	for (ctr = 0; ctr < 4; ctr++) {
		...
		dataptr[DCTSIZE * 1] = (DCTELEM)RIGHT_SHIFT(tmp0 + MULTIPLY(tmp10, FIX_0_765366865), /* c2-c6 */
		                                            CONST_BITS + PASS1_BITS);
		dataptr[DCTSIZE * 3] = (DCTELEM)RIGHT_SHIFT(tmp0 - MULTIPLY(tmp11, FIX_1_847759065), /* c2+c6 */
		                                            CONST_BITS + PASS1_BITS);
...
jpeg_fdct_3x3(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 3; ctr++) {
		...
		/* Apply unsigned->signed conversion. */
		dataptr[0] = (DCTELEM)((tmp0 + tmp1 - 3 * CENTERJSAMPLE) << (PASS1_BITS + 2));
		dataptr[2] = (DCTELEM)DESCALE(MULTIPLY(tmp0 - tmp1 - tmp1, FIX(0.707106781)), /* c2 */
		                              CONST_BITS - PASS1_BITS - 2);

		/* Odd part */

		dataptr[1] = (DCTELEM)DESCALE(MULTIPLY(tmp2, FIX(1.224744871)), /* c1 */
		                              CONST_BITS - PASS1_BITS - 2);
	...
	for (ctr = 0; ctr < 3; ctr++) {
		...
		dataptr[DCTSIZE * 0] = (DCTELEM)DESCALE(MULTIPLY(tmp0 + tmp1, FIX(1.777777778)), /* 16/9 */
		                                        CONST_BITS + PASS1_BITS);
		dataptr[DCTSIZE * 2] = (DCTELEM)DESCALE(MULTIPLY(tmp0 - tmp1 - tmp1, FIX(1.257078722)), /* c2 */
		                                        CONST_BITS + PASS1_BITS);

		/* Odd part */

		dataptr[DCTSIZE * 1] = (DCTELEM)DESCALE(MULTIPLY(tmp2, FIX(2.177324216)), /* c1 */
		                                        CONST_BITS + PASS1_BITS);
...
jpeg_fdct_9x9(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (;;) {
		...
		dataptr[6] = (DCTELEM)DESCALE(MULTIPLY(z1 - z2 - z2, FIX(0.707106781)), /* c6 */
		                              CONST_BITS - 1);
		z1         = MULTIPLY(tmp0 - tmp2, FIX(1.328926049));                 /* c2 */
		z2         = MULTIPLY(tmp1 - tmp4 - tmp4, FIX(0.707106781));          /* c6 */
		dataptr[2] = (DCTELEM)DESCALE(MULTIPLY(tmp2 - tmp3, FIX(1.083350441)) /* c4 */
		                                  + z1
		                                  + z2,
		                              CONST_BITS - 1);
		dataptr[4] = (DCTELEM)DESCALE(MULTIPLY(tmp3 - tmp0, FIX(0.245575608)) /* c8 */
		                                  + z1
		                                  - z2,
		                              CONST_BITS - 1);
		...
		dataptr[3] = (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp12 - tmp13, FIX(1.224744871)), /* c3 */
		                              CONST_BITS - 1);
	...
	for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
		...
		z1                   = tmp0 + tmp2 + tmp3;
		z2                   = tmp1 + tmp4;
		dataptr[DCTSIZE * 0] = (DCTELEM)DESCALE(MULTIPLY(z1 + z2, FIX(1.580246914)), /* 128/81 */
		                                        CONST_BITS + 2);
		dataptr[DCTSIZE * 6] = (DCTELEM)DESCALE(MULTIPLY(z1 - z2 - z2, FIX(1.117403309)), /* c6 */
		                                        CONST_BITS + 2);
		z1                   = MULTIPLY(tmp0 - tmp2, FIX(2.100031287));                 /* c2 */
		z2                   = MULTIPLY(tmp1 - tmp4 - tmp4, FIX(1.117403309));          /* c6 */
		dataptr[DCTSIZE * 2] = (DCTELEM)DESCALE(MULTIPLY(tmp2 - tmp3, FIX(1.711961190)) /* c4 */
		                                            + z1
		                                            + z2,
		                                        CONST_BITS + 2);
		dataptr[DCTSIZE * 4] = (DCTELEM)DESCALE(MULTIPLY(tmp3 - tmp0, FIX(0.388070096)) /* c8 */
		                                            + z1
		                                            - z2,
		                                        CONST_BITS + 2);
		...
		dataptr[DCTSIZE * 3] = (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp12 - tmp13, FIX(1.935399303)), /* c3 */
		                                        CONST_BITS + 2);
		...
		dataptr[DCTSIZE * 1] = (DCTELEM)DESCALE(tmp11 + tmp0 + tmp1, CONST_BITS + 2);

		tmp2 = MULTIPLY(tmp12 - tmp13, FIX(2.200854883)); /* c1 */

		dataptr[DCTSIZE * 5] = (DCTELEM)DESCALE(tmp0 - tmp11 - tmp2, CONST_BITS + 2);
		dataptr[DCTSIZE * 7] = (DCTELEM)DESCALE(tmp1 - tmp11 + tmp2, CONST_BITS + 2);
...
jpeg_fdct_10x10(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (;;) {
		...
		/* Apply unsigned->signed conversion. */
		dataptr[0] = (DCTELEM)((tmp10 + tmp11 + tmp12 - 10 * CENTERJSAMPLE) << 1);
		tmp12 += tmp12;
		dataptr[4] = (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp12, FIX(1.144122806)) -    /* c4 */
		                                  MULTIPLY(tmp11 - tmp12, FIX(0.437016024)), /* c8 */
		                              CONST_BITS - 1);
		tmp10      = MULTIPLY(tmp13 + tmp14, FIX(0.831253876));                  /* c6 */
		dataptr[2] = (DCTELEM)DESCALE(tmp10 + MULTIPLY(tmp13, FIX(0.513743148)), /* c2-c6 */
		                              CONST_BITS - 1);
		dataptr[6] = (DCTELEM)DESCALE(tmp10 - MULTIPLY(tmp14, FIX(2.176250899)), /* c2+c6 */
		                              CONST_BITS - 1);
		...
		tmp2 <<= CONST_BITS;
		dataptr[1] = (DCTELEM)DESCALE(MULTIPLY(tmp0, FIX(1.396802247)) + /* c1 */
		                                  MULTIPLY(tmp1, FIX(1.260073511))
		                                  + tmp2
		                                  + /* c3 */
	...
	for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
		...
		dataptr[DCTSIZE * 0] = (DCTELEM)DESCALE(MULTIPLY(tmp10 + tmp11 + tmp12, FIX(1.28)), /* 32/25 */
		                                        CONST_BITS + 2);
		tmp12 += tmp12;
		dataptr[DCTSIZE * 4] = (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp12, FIX(1.464477191)) -    /* c4 */
		                                            MULTIPLY(tmp11 - tmp12, FIX(0.559380511)), /* c8 */
		                                        CONST_BITS + 2);
		tmp10                = MULTIPLY(tmp13 + tmp14, FIX(1.064004961));                  /* c6 */
		dataptr[DCTSIZE * 2] = (DCTELEM)DESCALE(tmp10 + MULTIPLY(tmp13, FIX(0.657591230)), /* c2-c6 */
		                                        CONST_BITS + 2);
		dataptr[DCTSIZE * 6] = (DCTELEM)DESCALE(tmp10 - MULTIPLY(tmp14, FIX(2.785601151)), /* c2+c6 */
		                                        CONST_BITS + 2);
		...
		tmp10                = tmp0 + tmp4;
		tmp11                = tmp1 - tmp3;
		dataptr[DCTSIZE * 5] = (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp11 - tmp2, FIX(1.28)), /* 32/25 */
		                                        CONST_BITS + 2);
		tmp2                 = MULTIPLY(tmp2, FIX(1.28));                          /* 32/25 */
		dataptr[DCTSIZE * 1] = (DCTELEM)DESCALE(MULTIPLY(tmp0, FIX(1.787906876)) + /* c1 */
		                                            MULTIPLY(tmp1, FIX(1.612894094))
		                                            + tmp2
		                                            + /* c3 */
...
jpeg_fdct_11x11(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (;;) {
		...
		/* Apply unsigned->signed conversion. */
		dataptr[0] = (DCTELEM)((tmp0 + tmp1 + tmp2 + tmp3 + tmp4 + tmp5 - 11 * CENTERJSAMPLE) << 1);
		tmp5 += tmp5;
		tmp0 -= tmp5;
		tmp1 -= tmp5;
		tmp2 -= tmp5;
		...
		dataptr[2] = (DCTELEM)DESCALE(z1 + z2 - MULTIPLY(tmp3, FIX(1.018300590)) /* c2+c8-c6 */
		                                  - MULTIPLY(tmp4, FIX(1.390975730)),    /* c4+c10 */
		                              CONST_BITS - 1);
		dataptr[4] = (DCTELEM)DESCALE(z2 + z3 + MULTIPLY(tmp1, FIX(0.062335650)) /* c4-c6-c10 */
		                                  - MULTIPLY(tmp2, FIX(1.356927976))     /* c2 */
		                                  + MULTIPLY(tmp4, FIX(0.587485545)),    /* c8 */
		                              CONST_BITS - 1);
		dataptr[6] = (DCTELEM)DESCALE(z1 + z3 - MULTIPLY(tmp0, FIX(1.620527200)) /* c2+c4-c6 */
	...
	for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
		...
		dataptr[DCTSIZE * 0]
		    = (DCTELEM)DESCALE(MULTIPLY(tmp0 + tmp1 + tmp2 + tmp3 + tmp4 + tmp5, FIX(1.057851240)), /* 128/121 */
		                       CONST_BITS + 2);
		tmp5 += tmp5;
		tmp0 -= tmp5;
		tmp1 -= tmp5;
		...
		dataptr[DCTSIZE * 2] = (DCTELEM)DESCALE(z1 + z2 - MULTIPLY(tmp3, FIX(1.077210542)) /* c2+c8-c6 */
		                                            - MULTIPLY(tmp4, FIX(1.471445400)),    /* c4+c10 */
		                                        CONST_BITS + 2);
		dataptr[DCTSIZE * 4] = (DCTELEM)DESCALE(z2 + z3 + MULTIPLY(tmp1, FIX(0.065941844)) /* c4-c6-c10 */
		                                            - MULTIPLY(tmp2, FIX(1.435427942))     /* c2 */
		                                            + MULTIPLY(tmp4, FIX(0.621472312)),    /* c8 */
		                                        CONST_BITS + 2);
		dataptr[DCTSIZE * 6] = (DCTELEM)DESCALE(z1 + z3 - MULTIPLY(tmp0, FIX(1.714276708)) /* c2+c4-c6 */
...
jpeg_fdct_12x12(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (;;) {
		...
		dataptr[4] = (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp12, FIX(1.224744871)), /* c4 */
		                              CONST_BITS);
		dataptr[2] = (DCTELEM)DESCALE(tmp14 - tmp15 + MULTIPLY(tmp13 + tmp15, FIX(1.366025404)), /* c2 */
		                              CONST_BITS);
	...
	for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
		...
		dataptr[DCTSIZE * 0] = (DCTELEM)DESCALE(MULTIPLY(tmp10 + tmp11 + tmp12, FIX(0.888888889)), /* 8/9 */
		                                        CONST_BITS + 1);
		dataptr[DCTSIZE * 6] = (DCTELEM)DESCALE(MULTIPLY(tmp13 - tmp14 - tmp15, FIX(0.888888889)), /* 8/9 */
		                                        CONST_BITS + 1);
		dataptr[DCTSIZE * 4] = (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp12, FIX(1.088662108)), /* c4 */
		                                        CONST_BITS + 1);
		dataptr[DCTSIZE * 2] = (DCTELEM)DESCALE(MULTIPLY(tmp14 - tmp15, FIX(0.888888889)) +    /* 8/9 */
...
jpeg_fdct_13x13(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (;;) {
		...
		/* Apply unsigned->signed conversion. */
		dataptr[0] = (DCTELEM)(tmp0 + tmp1 + tmp2 + tmp3 + tmp4 + tmp5 + tmp6 - 13 * CENTERJSAMPLE);
		tmp6 += tmp6;
		tmp0 -= tmp6;
		tmp1 -= tmp6;
		tmp2 -= tmp6;
		...
		tmp4 -= tmp6;
		tmp5 -= tmp6;
		dataptr[2] = (DCTELEM)DESCALE(MULTIPLY(tmp0, FIX(1.373119086)) + /* c2 */
		...
		tmp0 = tmp1 + tmp2 + tmp3 - MULTIPLY(tmp10, FIX(2.020082300)) + /* c3+c5+c7-c1 */
		       MULTIPLY(tmp14, FIX(0.318774355));                       /* c9-c11 */
		tmp4 = MULTIPLY(tmp14 - tmp15, FIX(0.937797057)) -              /* c7 */
		       MULTIPLY(tmp11 + tmp12, FIX(0.338443458));               /* c11 */
		tmp5 = MULTIPLY(tmp11 + tmp13, -FIX(1.163874945));              /* -c5 */
		tmp1 += tmp4 + tmp5 + MULTIPLY(tmp11, FIX(0.837223564)) -       /* c5+c9+c11-c3 */
		        MULTIPLY(tmp14, FIX(2.341699410));                      /* c1+c7 */
		tmp6 = MULTIPLY(tmp12 + tmp13, -FIX(0.657217813));              /* -c9 */
		tmp2 += tmp4 + tmp6 - MULTIPLY(tmp12, FIX(1.572116027)) +       /* c1+c5-c9-c11 */
		        MULTIPLY(tmp15, FIX(2.260109708));                      /* c3+c7 */
		tmp3 += tmp5 + tmp6 + MULTIPLY(tmp13, FIX(2.205608352)) -       /* c3+c5+c9-c7 */
	...
	for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
		...
		dataptr[DCTSIZE * 0]
		    = (DCTELEM)DESCALE(MULTIPLY(tmp0 + tmp1 + tmp2 + tmp3 + tmp4 + tmp5 + tmp6, FIX(0.757396450)), /* 128/169 */
		                       CONST_BITS + 1);
		tmp6 += tmp6;
		tmp0 -= tmp6;
		tmp1 -= tmp6;
		...
		tmp4 -= tmp6;
		tmp5 -= tmp6;
		dataptr[DCTSIZE * 2] = (DCTELEM)DESCALE(MULTIPLY(tmp0, FIX(1.039995521)) + /* c2 */
		...
		tmp0 = tmp1 + tmp2 + tmp3 - MULTIPLY(tmp10, FIX(1.530003162)) + /* c3+c5+c7-c1 */
		       MULTIPLY(tmp14, FIX(0.241438564));                       /* c9-c11 */
		tmp4 = MULTIPLY(tmp14 - tmp15, FIX(0.710284161)) -              /* c7 */
		       MULTIPLY(tmp11 + tmp12, FIX(0.256335874));               /* c11 */
		tmp5 = MULTIPLY(tmp11 + tmp13, -FIX(0.881514751));              /* -c5 */
		tmp1 += tmp4 + tmp5 + MULTIPLY(tmp11, FIX(0.634110155)) -       /* c5+c9+c11-c3 */
		        MULTIPLY(tmp14, FIX(1.773594819));                      /* c1+c7 */
		tmp6 = MULTIPLY(tmp12 + tmp13, -FIX(0.497774438));              /* -c9 */
		tmp2 += tmp4 + tmp6 - MULTIPLY(tmp12, FIX(1.190715098)) +       /* c1+c5-c9-c11 */
		        MULTIPLY(tmp15, FIX(1.711799069));                      /* c3+c7 */
		tmp3 += tmp5 + tmp6 + MULTIPLY(tmp13, FIX(1.670519935)) -       /* c3+c5+c9-c7 */
...
jpeg_fdct_14x14(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (;;) {
		...
		/* Apply unsigned->signed conversion. */
		dataptr[0] = (DCTELEM)(tmp10 + tmp11 + tmp12 + tmp13 - 14 * CENTERJSAMPLE);
		tmp13 += tmp13;
		dataptr[4] = (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp13, FIX(1.274162392)) + /* c4 */
		...
		dataptr[2] = (DCTELEM)DESCALE(tmp10 + MULTIPLY(tmp14, FIX(0.273079590)) /* c2-c6 */
		                                  + MULTIPLY(tmp16, FIX(0.613604268)),  /* c10 */
		                              CONST_BITS);
		dataptr[6] = (DCTELEM)DESCALE(tmp10 - MULTIPLY(tmp15, FIX(1.719280954)) /* c6+c10 */
		...
		dataptr[5] = (DCTELEM)DESCALE(tmp10 + tmp11 - MULTIPLY(tmp2, FIX(2.373959773)) /* c3+c5-c13 */
		                                  + MULTIPLY(tmp4, FIX(1.119999435)),          /* c1+c11-c9 */
		                              CONST_BITS);
		tmp12 = MULTIPLY(tmp0 + tmp1, FIX(1.334852607)) +                              /* c3 */
		        MULTIPLY(tmp5 - tmp6, FIX(0.467085129));                               /* c11 */
		dataptr[3] = (DCTELEM)DESCALE(tmp10 + tmp12 - MULTIPLY(tmp1, FIX(0.424103948)) /* c3-c9-c13 */
		                                  - MULTIPLY(tmp5, FIX(3.069855259)),          /* c1+c5+c11 */
		                              CONST_BITS);
		dataptr[1]
		    = (DCTELEM)DESCALE(tmp11 + tmp12 + tmp3 + tmp6 - MULTIPLY(tmp0 + tmp6, FIX(1.126980169)), /* c3+c5-c1 */
		                       CONST_BITS);
	...
	for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
		...
		dataptr[DCTSIZE * 0] = (DCTELEM)DESCALE(MULTIPLY(tmp10 + tmp11 + tmp12 + tmp13, FIX(0.653061224)), /* 32/49 */
		                                        CONST_BITS + 1);
		tmp13 += tmp13;
		dataptr[DCTSIZE * 4] = (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp13, FIX(0.832106052)) + /* c4 */
		...
		dataptr[DCTSIZE * 2] = (DCTELEM)DESCALE(tmp10 + MULTIPLY(tmp14, FIX(0.178337691)) /* c2-c6 */
		                                            + MULTIPLY(tmp16, FIX(0.400721155)),  /* c10 */
		                                        CONST_BITS + 1);
		dataptr[DCTSIZE * 6] = (DCTELEM)DESCALE(tmp10 - MULTIPLY(tmp15, FIX(1.122795725)) /* c6+c10 */
		...
		tmp11 = tmp5 - tmp4;
		dataptr[DCTSIZE * 7]
		    = (DCTELEM)DESCALE(MULTIPLY(tmp0 - tmp10 + tmp3 - tmp11 - tmp6, FIX(0.653061224)), /* 32/49 */
		                       CONST_BITS + 1);
		...
		dataptr[DCTSIZE * 5] = (DCTELEM)DESCALE(tmp10 + tmp11 - MULTIPLY(tmp2, FIX(1.550341076)) /* c3+c5-c13 */
		                                            + MULTIPLY(tmp4, FIX(0.731428202)),          /* c1+c11-c9 */
		                                        CONST_BITS + 1);
		tmp12 = MULTIPLY(tmp0 + tmp1, FIX(0.871740478)) +                                        /* c3 */
		        MULTIPLY(tmp5 - tmp6, FIX(0.305035186));                                         /* c11 */
		dataptr[DCTSIZE * 3] = (DCTELEM)DESCALE(tmp10 + tmp12 - MULTIPLY(tmp1, FIX(0.276965844)) /* c3-c9-c13 */
		                                            - MULTIPLY(tmp5, FIX(2.004803435)),          /* c1+c5+c11 */
		                                        CONST_BITS + 1);
		dataptr[DCTSIZE * 1] = (DCTELEM)DESCALE(tmp11 + tmp12 + tmp3 - MULTIPLY(tmp0, FIX(0.735987049)) /* c3+c5-c1 */
...
jpeg_fdct_15x15(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (;;) {
		...
		z3 += z3;
		dataptr[6] = (DCTELEM)DESCALE(MULTIPLY(z1 - z3, FIX(1.144122806)) -    /* c6 */
		...
		tmp2 = MULTIPLY(tmp10 - tmp12 - tmp13 + tmp15 + tmp16, FIX(1.224744871)); /* c5 */
	...
	for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
		...
		z2                   = tmp1 + tmp3 + tmp6;
		z3                   = tmp2 + tmp7;
		dataptr[DCTSIZE * 0] = (DCTELEM)DESCALE(MULTIPLY(z1 + z2 + z3, FIX(1.137777778)), /* 256/225 */
		                                        CONST_BITS + 2);
		z3 += z3;
		dataptr[DCTSIZE * 6] = (DCTELEM)DESCALE(MULTIPLY(z1 - z3, FIX(1.301757503)) -    /* c6 */
		...
		tmp2 = MULTIPLY(tmp10 - tmp12 - tmp13 + tmp15 + tmp16, FIX(1.393487498)); /* c5 */
...
jpeg_fdct_16x16(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (;;) {
		...
		/* Apply unsigned->signed conversion. */
		dataptr[0] = (DCTELEM)((tmp10 + tmp11 + tmp12 + tmp13 - 16 * CENTERJSAMPLE) << PASS1_BITS);
		dataptr[4] = (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp13, FIX(1.306562965)) +   /* c4[16] = c2[8] */
		...
		dataptr[2] = (DCTELEM)DESCALE(tmp10 + MULTIPLY(tmp15, FIX(1.451774982)) /* c6+c14 */
		                                  + MULTIPLY(tmp16, FIX(2.172734804)),  /* c2+c10 */
		                              CONST_BITS - PASS1_BITS);
		dataptr[6] = (DCTELEM)DESCALE(tmp10 - MULTIPLY(tmp14, FIX(0.211164243)) /* c2-c6 */
		...
		tmp10 = tmp11 + tmp12 + tmp13 - MULTIPLY(tmp0, FIX(2.286341144)) + /* c7+c5+c3-c1 */
	...
	for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
		...
		dataptr[DCTSIZE * 0] = (DCTELEM)DESCALE(tmp10 + tmp11 + tmp12 + tmp13, PASS1_BITS + 2);
		dataptr[DCTSIZE * 4] = (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp13, FIX(1.306562965)) +   /* c4[16] = c2[8] */
		                                            MULTIPLY(tmp11 - tmp12, FIX_0_541196100), /* c12[16] = c6[8] */
		                                        CONST_BITS + PASS1_BITS + 2);
		...
		dataptr[DCTSIZE * 2] = (DCTELEM)DESCALE(tmp10 + MULTIPLY(tmp15, FIX(1.451774982)) /* c6+c14 */
		                                            + MULTIPLY(tmp16, FIX(2.172734804)),  /* c2+10 */
		                                        CONST_BITS + PASS1_BITS + 2);
		dataptr[DCTSIZE * 6] = (DCTELEM)DESCALE(tmp10 - MULTIPLY(tmp14, FIX(0.211164243)) /* c2-c6 */
		                                            - MULTIPLY(tmp17, FIX(1.061594338)),  /* c10+c14 */
		                                        CONST_BITS + PASS1_BITS + 2);
...
jpeg_fdct_16x8(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
		...
		z1                   = MULTIPLY(tmp12 + tmp13, FIX_0_541196100);               /* c6 */
		dataptr[DCTSIZE * 2] = (DCTELEM)DESCALE(z1 + MULTIPLY(tmp12, FIX_0_765366865), /* c2-c6 */
		                                        CONST_BITS + PASS1_BITS + 1);
		dataptr[DCTSIZE * 6] = (DCTELEM)DESCALE(z1 - MULTIPLY(tmp13, FIX_1_847759065), /* c2+c6 */
		                                        CONST_BITS + PASS1_BITS + 1);
...
jpeg_fdct_14x7(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 7; ctr++) {
		...
		/* Apply unsigned->signed conversion. */
		dataptr[0] = (DCTELEM)((tmp10 + tmp11 + tmp12 + tmp13 - 14 * CENTERJSAMPLE) << PASS1_BITS);
		tmp13 += tmp13;
		dataptr[4] = (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp13, FIX(1.274162392)) + /* c4 */
		                                  MULTIPLY(tmp11 - tmp13, FIX(0.314692123))
		                                  -                                          /* c12 */
...
jpeg_fdct_12x6(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 6; ctr++) {
		...
		/* Apply unsigned->signed conversion. */
		dataptr[0] = (DCTELEM)((tmp10 + tmp11 + tmp12 - 12 * CENTERJSAMPLE) << PASS1_BITS);
...
jpeg_fdct_10x5(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 5; ctr++) {
		...
		/* Apply unsigned->signed conversion. */
		dataptr[0] = (DCTELEM)((tmp10 + tmp11 + tmp12 - 10 * CENTERJSAMPLE) << PASS1_BITS);
		tmp12 += tmp12;
		dataptr[4] = (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp12, FIX(1.144122806)) -    /* c4 */
		                                  MULTIPLY(tmp11 - tmp12, FIX(0.437016024)), /* c8 */
		                              CONST_BITS - PASS1_BITS);
...
jpeg_fdct_8x4(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 4; ctr++) {
		...
		/* Apply unsigned->signed conversion. */
		dataptr[0] = (DCTELEM)((tmp10 + tmp11 - 8 * CENTERJSAMPLE) << (PASS1_BITS + 1));
...
jpeg_fdct_6x3(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 3; ctr++) {
		...
		/* Apply unsigned->signed conversion. */
		dataptr[0] = (DCTELEM)((tmp10 + tmp11 - 6 * CENTERJSAMPLE) << (PASS1_BITS + 1));
		dataptr[2] = (DCTELEM)DESCALE(MULTIPLY(tmp12, FIX(1.224744871)), /* c2 */
		                              CONST_BITS - PASS1_BITS - 1);
		dataptr[4] = (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp11 - tmp11, FIX(0.707106781)), /* c4 */
		                              CONST_BITS - PASS1_BITS - 1);
...
jpeg_fdct_4x2(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 2; ctr++) {
		...
		/* Apply unsigned->signed conversion. */
		dataptr[0] = (DCTELEM)((tmp0 + tmp1 - 4 * CENTERJSAMPLE) << (PASS1_BITS + 3));
...
jpeg_fdct_8x16(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (;;) {
		...
		z1         = MULTIPLY(tmp12 + tmp13, FIX_0_541196100);               /* c6 */
		dataptr[2] = (DCTELEM)DESCALE(z1 + MULTIPLY(tmp12, FIX_0_765366865), /* c2-c6 */
		                              CONST_BITS - PASS1_BITS);
		dataptr[6] = (DCTELEM)DESCALE(z1 - MULTIPLY(tmp13, FIX_1_847759065), /* c2+c6 */
		                              CONST_BITS - PASS1_BITS);
	...
	for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
		...
		dataptr[DCTSIZE * 0] = (DCTELEM)DESCALE(tmp10 + tmp11 + tmp12 + tmp13, PASS1_BITS + 1);
		dataptr[DCTSIZE * 4] = (DCTELEM)DESCALE(MULTIPLY(tmp10 - tmp13, FIX(1.306562965)) +   /* c4[16] = c2[8] */
		                                            MULTIPLY(tmp11 - tmp12, FIX_0_541196100), /* c12[16] = c6[8] */
		                                        CONST_BITS + PASS1_BITS + 1);
...
jpeg_fdct_5x10(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (;;) {
		...
		/* Apply unsigned->signed conversion. */
		dataptr[0] = (DCTELEM)((tmp10 + tmp2 - 5 * CENTERJSAMPLE) << PASS1_BITS);
		tmp11      = MULTIPLY(tmp11, FIX(0.790569415)); /* (c2+c4)/2 */
		tmp10 -= tmp2 << 2;
		tmp10      = MULTIPLY(tmp10, FIX(0.353553391)); /* (c2-c4)/2 */
...
jpeg_fdct_4x8(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < DCTSIZE; ctr++) {
		...
		/* Apply unsigned->signed conversion. */
		dataptr[0] = (DCTELEM)((tmp0 + tmp1 - 4 * CENTERJSAMPLE) << (PASS1_BITS + 1));
...
jpeg_fdct_3x6(DCTELEM *data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 6; ctr++) {
		...
		/* Apply unsigned->signed conversion. */
		dataptr[0] = (DCTELEM)((tmp0 + tmp1 - 3 * CENTERJSAMPLE) << (PASS1_BITS + 1));
		dataptr[2] = (DCTELEM)DESCALE(MULTIPLY(tmp0 - tmp1 - tmp1, FIX(0.707106781)), /* c2 */
		                              CONST_BITS - PASS1_BITS - 1);
